...
import (
	...
	"github.com/socialpay/socialpay/src/pkg/wallet/usecase"
)
...
func NewWalletController(walletUseCase usecase.WalletUseCase, middleware gin.HandlerFunc) *WalletController {
...
func (c *WalletController) RegisterRoutes(router *gin.RouterGroup) {
	...
	{
		wallet.GET("", c.GetMerchantWallet)
	}
}
