...
) RETURNING id, user_id, merchant_id, amount, currency, description, reference, supported_mediums, phone_number, success_url, failed_url, callback_url, status, transaction_id, selected_medium, selected_phone_number, created_at, updated_at, expires_at
`
...
SELECT id, user_id, merchant_id, amount, currency, description, reference, supported_mediums, phone_number, success_url, failed_url, callback_url, status, transaction_id, selected_medium, selected_phone_number, created_at, updated_at, expires_at FROM public.hosted_payments 
...
SELECT 
    t.id, t.phone_number, t.user_id, t.merchant_id, t.type, t.medium, t.reference, t.comment, t.reference_number, t.description, t.verified, t.status, t.test, t.has_challenge, t.webhook_received, t.ttl, t.created_at, t.updated_at, t.confirm_timestamp, t.amount, t.fee_amount, t.admin_net, t.vat_amount, t.merchant_net, t.total_amount, t.currency, t.details, t.token, t.callback_url, t.success_url, t.failed_url, t.transaction_source, t.qr_link_id, t.hosted_checkout_id, t.qr_tag, t.has_tip, t.tip_amount, t.tipee_phone, t.tip_medium, t.tip_transaction_id, t.tip_processed,
    m.id as merchant_id,
